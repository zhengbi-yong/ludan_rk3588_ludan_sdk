...
bool motor_feedback__msg__motor_feedback_with_state__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("motor_feedback.msg._motor_feedback_with_state.MotorFeedbackWithState", full_classname_dest, 68) == 0);
  }
  motor_feedback__msg__MotorFeedbackWithState * ros_message = _ros_message;
  {  // id
...
{
  /* NOTE(esteve): Call constructor of MotorFeedbackWithState */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("motor_feedback.msg._motor_feedback_with_state");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "MotorFeedbackWithState");
