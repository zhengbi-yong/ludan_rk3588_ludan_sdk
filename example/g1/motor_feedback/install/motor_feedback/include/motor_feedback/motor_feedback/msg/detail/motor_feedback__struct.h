...
#ifndef MOTOR_FEEDBACK__MSG__DETAIL__MOTOR_FEEDBACK__STRUCT_H_
#define MOTOR_FEEDBACK__MSG__DETAIL__MOTOR_FEEDBACK__STRUCT_H_
...
/// Struct defined in msg/MotorFeedback in the package motor_feedback.
/**
  * MotorFeedback.msg
  * DM Motor feedback message from CAN bus
  * Compatible with motor_controller_with_enable
 */
typedef struct motor_feedback__msg__MotorFeedback
{
...
// Struct for a sequence of motor_feedback__msg__MotorFeedback.
typedef struct motor_feedback__msg__MotorFeedback__Sequence
{
...
#endif  // MOTOR_FEEDBACK__MSG__DETAIL__MOTOR_FEEDBACK__STRUCT_H_
