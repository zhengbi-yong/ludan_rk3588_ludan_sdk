...
multi_port_motor_feedback__msg__MotorState__create()
{
  ...
  multi_port_motor_feedback__msg__MotorState * msg = (multi_port_motor_feedback__msg__MotorState *)allocator.allocate(sizeof(multi_port_motor_feedback__msg__MotorState), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(multi_port_motor_feedback__msg__MotorState));
  bool success = multi_port_motor_feedback__msg__MotorState__init(msg);
  if (!success) {
...
multi_port_motor_feedback__msg__MotorState__destroy(multi_port_motor_feedback__msg__MotorState * msg)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (msg) {
    multi_port_motor_feedback__msg__MotorState__fini(msg);
  }
  allocator.deallocate(msg, allocator.state);
}
...
multi_port_motor_feedback__msg__MotorState__Sequence__init(multi_port_motor_feedback__msg__MotorState__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  multi_port_motor_feedback__msg__MotorState * data = NULL;

  if (size) {
    data = (multi_port_motor_feedback__msg__MotorState *)allocator.zero_allocate(size, sizeof(multi_port_motor_feedback__msg__MotorState), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = multi_port_motor_feedback__msg__MotorState__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        multi_port_motor_feedback__msg__MotorState__fini(&data[i - 1]);
      }
...
multi_port_motor_feedback__msg__MotorState__Sequence__fini(multi_port_motor_feedback__msg__MotorState__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      multi_port_motor_feedback__msg__MotorState__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  multi_port_motor_feedback__msg__MotorState__Sequence * array = (multi_port_motor_feedback__msg__MotorState__Sequence *)allocator.allocate(sizeof(multi_port_motor_feedback__msg__MotorState__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = multi_port_motor_feedback__msg__MotorState__Sequence__init(array, size);
  if (!success) {
...
multi_port_motor_feedback__msg__MotorState__Sequence__destroy(multi_port_motor_feedback__msg__MotorState__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    multi_port_motor_feedback__msg__MotorState__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
multi_port_motor_feedback__msg__MotorState__Sequence__are_equal(const multi_port_motor_feedback__msg__MotorState__Sequence * lhs, const multi_port_motor_feedback__msg__MotorState__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!multi_port_motor_feedback__msg__MotorState__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  multi_port_motor_feedback__msg__MotorState__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(multi_port_motor_feedback__msg__MotorState);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    multi_port_motor_feedback__msg__MotorState * data =
      (multi_port_motor_feedback__msg__MotorState *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!multi_port_motor_feedback__msg__MotorState__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          multi_port_motor_feedback__msg__MotorState__fini(&output->data[i]);
        }
        return false;
      }
    }
