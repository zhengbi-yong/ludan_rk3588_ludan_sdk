...
#ifndef MOTOR_FEEDBACK__MSG__DETAIL__MOTOR_FEEDBACK__STRUCT_HPP_
#define MOTOR_FEEDBACK__MSG__DETAIL__MOTOR_FEEDBACK__STRUCT_HPP_
...
#ifndef _WIN32
# define DEPRECATED__motor_feedback__msg__MotorFeedback __attribute__((deprecated))
#else
# define DEPRECATED__motor_feedback__msg__MotorFeedback __declspec(deprecated)
#endif
...
struct MotorFeedback_
{
  ...
  // pointer types
  using RawPtr =
    motor_feedback::msg::MotorFeedback_<ContainerAllocator> *;
  using ConstRawPtr =
    const motor_feedback::msg::MotorFeedback_<ContainerAllocator> *;
  using SharedPtr =
    std::shared_ptr<motor_feedback::msg::MotorFeedback_<ContainerAllocator>>;
  using ConstSharedPtr =
    std::shared_ptr<motor_feedback::msg::MotorFeedback_<ContainerAllocator> const>;

  template<typename Deleter = std::default_delete<
      motor_feedback::msg::MotorFeedback_<ContainerAllocator>>>
  using UniquePtrWithDeleter =
    std::unique_ptr<motor_feedback::msg::MotorFeedback_<ContainerAllocator>, Deleter>;
  ...
  using ConstUniquePtrWithDeleter =
    std::unique_ptr<motor_feedback::msg::MotorFeedback_<ContainerAllocator> const, Deleter>;
  using ConstUniquePtr = ConstUniquePtrWithDeleter<>;

  using WeakPtr =
    std::weak_ptr<motor_feedback::msg::MotorFeedback_<ContainerAllocator>>;
  using ConstWeakPtr =
    std::weak_ptr<motor_feedback::msg::MotorFeedback_<ContainerAllocator> const>;

  // pointer types similar to ROS 1, use SharedPtr / ConstSharedPtr instead
  // NOTE: Can't use 'using' here because GNU C++ can't parse attributes properly
  typedef DEPRECATED__motor_feedback__msg__MotorFeedback
    std::shared_ptr<motor_feedback::msg::MotorFeedback_<ContainerAllocator>>
    Ptr;
  typedef DEPRECATED__motor_feedback__msg__MotorFeedback
    std::shared_ptr<motor_feedback::msg::MotorFeedback_<ContainerAllocator> const>
...
using MotorFeedback =
  motor_feedback::msg::MotorFeedback_<std::allocator<void>>;
...
#endif  // MOTOR_FEEDBACK__MSG__DETAIL__MOTOR_FEEDBACK__STRUCT_HPP_
